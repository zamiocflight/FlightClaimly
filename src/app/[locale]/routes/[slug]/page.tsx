...
function localizeRoute(route: FlightRoute, locale: string) { if (locale === "sv") return applyKnowledgeLocalization(route, buildSwedishRouteLocalization(route)); if (locale === "da") return applyKnowledgeLocalization(route, buildDanishRouteLocalization(route)); if (locale === "pl") return applyKnowledgeLocalization(route, buildPolishRouteLocalization(route)); if (locale === "de") return applyKnowledgeLocalization(route, buildGermanRouteLocalization(route)); return route; }
function cityName(value: string, locale: string) { if (locale === "sv") return swedishCityName(value); if (locale === "da") return danishCityName(value); if (locale === "pl") return polishCityName(value); if (locale === "de") return germanCityName(value); return value; }
function countryName(value: string, locale: string) { if (locale === "sv") return swedishCountryName(value); if (locale === "da") return danishCountryName(value); if (locale === "pl") return polishCountryName(value); if (locale === "de") return germanCountryName(value); return value; }
