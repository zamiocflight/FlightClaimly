      ...
      <div className="max-w-3xl mx-auto px-6 py-12 text-slate-900">
        ...
        <section className="space-y-8 text-sm md:text-base text-slate-700">
          <div>
            ...
            <p className="mt-2">{t("controller.body")}</p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2">{t("dataCollected.intro")}</p>
          ...
          <div>
            ...
            <p className="mt-2">{t("purpose.intro")}</p>
            <ul className="mt-2 ml-5 list-disc space-y-1">
          ...
          <div>
            ...
            <p className="mt-2">{t("legalBasis.intro")}</p>
            <ul className="mt-2 ml-5 list-disc space-y-1">
          ...
          <div>
            ...
            <p className="mt-2">{t("retention.intro")}</p>
            <ul className="mt-2 ml-5 list-disc space-y-1">
              {t.raw("retention.items").map((item: string, i: number) => (
                <li key={i}>{item}</li>
              ))}
            </ul>
            <p className="mt-2 text-sm text-slate-600">{t("retention.note")}</p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2">{t("sharing.intro")}</p>
            <ul className="mt-2 ml-5 list-disc space-y-1">
              {t.raw("sharing.items").map((item: string, i: number) => (
                <li key={i}>{item}</li>
              ))}
            </ul>
            <p className="mt-2 text-sm text-slate-600">{t("sharing.note")}</p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2">{t("rights.intro")}</p>
            <ul className="mt-2 ml-5 list-disc space-y-1">
          ...
          <div>
            ...
            <p className="mt-2">{t("complaints.body")}</p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2">{t("changes.body")}</p>
          </div>
        </section>
