...
},
{
  ...
  mainAirlines: ["lot-polish-airlines", "wizz-air", "ryanair", "lufthansa", "klm", "air-france"],
},
{
  slug: "dublin-airport",
  name: "Dublin Airport",
...
},
{
  ...
  mainAirlines: ["ryanair", "lot-polish-airlines", "wizz-air", "lufthansa"],
},
{
  slug: "athens-airport",
...
},
{
  ...
  mainAirlines: ["ryanair", "wizz-air", "airbaltic", "lot-polish-airlines"],
},
{
...
},
{
  ...
  mainAirlines: ["ryanair", "easyjet", "km-malta-airlines"],
},
{
...
{
  slug: "aalborg-airport-aal",
  name: "Aalborg Airport",
  iata: "AAL",
  city: "Aalborg",
  country: "Denmark",
  regionDescription: "an important airport serving northern Denmark",
},
{
  slug: "antalya-international-airport-ayt",
  name: "Antalya International Airport",
  iata: "AYT",
  city: "Antalya",
  country: "Türkiye",
  regionDescription: "one of Türkiye's busiest airports and a major gateway to the Mediterranean coast",
},
{
  slug: "bergen-airport-flesland-bgo",
  name: "Bergen Airport, Flesland",
  iata: "BGO",
  city: "Bergen",
  country: "Norway",
  regionDescription: "one of Norway's busiest airports and the main international gateway to western Norway",
},
{
  slug: "burgas-airport-boj",
  name: "Burgas Airport",
  iata: "BOJ",
  city: "Burgas",
  country: "Bulgaria",
  regionDescription: "a major seasonal airport serving Bulgaria's Black Sea coast",
},
{
  slug: "chania-international-airport-chq",
  name: "Chania International Airport",
  iata: "CHQ",
  city: "Chania",
  country: "Greece",
  regionDescription: "a major international airport serving western Crete",
},
{
  slug: "chicago-o-hare-international-airport-ord",
  name: "Chicago O'Hare International Airport",
  iata: "ORD",
  city: "Chicago",
  country: "United States",
  regionDescription: "one of the largest international aviation hubs in the United States",
},
{
  ...
  city: "Palermo",
  country: "Italy",
  regionDescription: "the main international airport serving Palermo and western Sicily",
},
{
  slug: "florence-airport-peretola-flr",
  name: "Florence Airport, Peretola",
  iata: "FLR",
  city: "Florence",
  country: "Italy",
  regionDescription: "the main airport serving Florence and central Tuscany",
},
{
  slug: "gazipasa-alanya-airport-gzp",
  name: "Gazipaşa-Alanya Airport",
  iata: "GZP",
  city: "Gazipaşa",
  country: "Türkiye",
  regionDescription: "a regional international airport serving Alanya and Türkiye's Mediterranean coast",
},
{
  slug: "gdansk-lech-wa-esa-airport-gdn",
  name: "Gdańsk Lech Wałęsa Airport",
  iata: "GDN",
  city: "Gdańsk",
  country: "Poland",
  regionDescription: "one of Poland's major international airports and the main gateway to the Tricity area",
},
{
  slug: "goteborg-landvetter-airport-got",
  name: "Göteborg Landvetter Airport",
  iata: "GOT",
  city: "Göteborg",
  country: "Sweden",
  regionDescription: "western Sweden's largest international airport",
},
{
  ...
  city: "Istanbul",
  country: "Türkiye",
  regionDescription: "one of Europe's largest international aviation hubs",
},
{
  ...
  city: "Los Angeles",
  country: "United States",
  regionDescription: "one of the busiest international airports in the United States",
},
{
  slug: "pula-airport-puy",
  name: "Pula Airport",
  iata: "PUY",
  city: "Pula",
  country: "Croatia",
  regionDescription: "an important seasonal gateway to Croatia's Istrian peninsula",
},
{
  slug: "stavanger-airport-sola-svg",
  name: "Stavanger Airport, Sola",
  iata: "SVG",
  city: "Stavanger",
  country: "Norway",
  regionDescription: "a major airport serving southwestern Norway",
},
{
  slug: "troms-airport-langnes-tos",
  name: "Tromsø Airport, Langnes",
  iata: "TOS",
  city: "Tromsø",
  country: "Norway",
  regionDescription: "the main aviation gateway to Tromsø and northern Norway",
},
{
  slug: "trondheim-airport-v-rnes-trd",
  name: "Trondheim Airport, Værnes",
  iata: "TRD",
  city: "Trondheim",
  country: "Norway",
  regionDescription: "one of Norway's busiest regional and international airports",
},
{
  slug: "washington-dulles-international-airport-iad",
  name: "Washington Dulles International Airport",
  iata: "IAD",
  city: "Washington",
  country: "United States",
  regionDescription: "a major international gateway serving the Washington metropolitan area",
},
];
