...
const polishCityNames: Record<string, string> = {
  Athens: "Ateny", Belgrade: "Belgrad", Brussels: "Bruksela", Bucharest: "Bukareszt", Cairo: "Kair", Cologne: "Kolonia",
  Copenhagen: "Kopenhaga", Florence: "Florencja", Lisbon: "Lizbona", Milan: "Mediolan", Munich: "Monachium", Naples: "Neapol",
  Prague: "Praga", Rome: "Rzym", Seville: "Sewilla", Venice: "Wenecja", Vienna: "Wiedeń", Warsaw: "Warszawa", Zurich: "Zurych",
};
...
function compensationAmounts(flight: FlightNumber) {
  if (flight.eu261Eligible && flight.uk261Eligible) return [
    { label: "Do 1500 km", distance: "Lot krótkodystansowy", amount: "€250 / £220" }, { label: "1500–3500 km", distance: "Lot średniodystansowy", amount: "€400 / £350" }, { label: "Powyżej 3500 km", distance: "Lot długodystansowy", amount: "do €600 / £520" },
  ];
  if (flight.eu261Eligible) return [
    { label: "Do 1500 km", distance: "Lot krótkodystansowy", amount: "€250" }, { label: "1500–3500 km", distance: "Lot średniodystansowy", amount: "€400" }, { label: "Powyżej 3500 km", distance: "Lot długodystansowy", amount: "do €600" },
  ];
  if (flight.uk261Eligible) return [
    { label: "Do 1500 km", distance: "Lot krótkodystansowy", amount: "£220" }, { label: "1500–3500 km", distance: "Lot średniodystansowy", amount: "£350" }, { label: "Powyżej 3500 km", distance: "Lot długodystansowy", amount: "do £520" },
  ];
...
export function buildPolishFlightNumberLocalization(flight: FlightNumber): KnowledgeLocalization {
  ...
  const originName = origin?.name ?? flight.originAirportSlug; const destinationName = destination?.name ?? flight.destinationAirportSlug;
  const originCity = polishCityName(origin?.city ?? originName); const destinationCity = polishCityName(destination?.city ?? destinationName); const regulation = regulationLabel(flight);
  return {
    ...
    metadata: {
      ...
      description: `Sprawdź, czy przysługuje Ci odszkodowanie za opóźniony lub odwołany lot ${flight.airlineName} ${flight.flightNumber} na trasie ${originCity}–${destinationCity} zgodnie z ${regulation}.`,
    },
    content: {
