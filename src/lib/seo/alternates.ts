...
export const routeSeoLocales = ["en", "sv", "da", "pl"] as const;
export const airportSeoLocales = ["en", "sv", "da", "pl"] as const;
export const airlineSeoLocales = ["en", "sv", "da", "pl"] as const;
export const countrySeoLocales = ["en", "sv", "da", "pl"] as const;
export const delayReasonSeoLocales = ["en", "sv", "da", "pl"] as const;
