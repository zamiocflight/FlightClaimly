...
export const routeSeoLocales = ["en", "sv", "da"] as const;
export const airportSeoLocales = ["en", "sv", "da"] as const;
export const airlineSeoLocales = ["en", "sv", "da"] as const;
export const countrySeoLocales = ["en", "sv", "da"] as const;
export const delayReasonSeoLocales = ["en", "sv", "da"] as const;
